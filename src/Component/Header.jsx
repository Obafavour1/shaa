...
const Header = () => {
  ...
  return (
    <header id='header' className=' md:h-screen bg-banner bg-contain  bg-blend-screen bg-center bg-no-repeat  relative '>
      ...
      <div className='w-full pt-[150px] md:pt-[150px]  mb-8 flex flex-col items-center justify-center'>
        ...
        <div className='mt-[40px] flex rounded  '>
          <input type="email" name="email" className=' text-black text-[14px] rounded-l py-3 px-[3px] md:py-4 md:px-[16px]' id="" placeholder='Enter your Email address'/>
          <button type="submit" className='bg-primary rounded-r text-black font-bold text-[15px] py-3 md:py-4 px-[5px] md:px-[20.5px]'>Join wait list</button>
        </div>
      </div>
    </header>
  )
